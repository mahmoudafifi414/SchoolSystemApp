                                            ...
                                            <div className="panel-body">
                                                <ul className="nav navbar-nav">
                                                    <li><a href="#" id="all_semesters"
                                                           onClick={this.getLinkNameInSideNavigation}>All
                                                        Semesters</a></li>
                                                    <li><a href="#" id="add_edit_semester"
                                                           onClick={this.getLinkNameInSideNavigation}>Add Edit</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </li>
                                            ...
                                            <div className="panel-body">
                                                <ul className="nav navbar-nav">
                                                    <li><a href="#" id="all_years"
                                                           onClick={this.getLinkNameInSideNavigation}>All
                                                        Years</a></li>
                                                    <li><a href="#" id="add_edit_year"
                                                           onClick={this.getLinkNameInSideNavigation}>Add Year</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </li>
