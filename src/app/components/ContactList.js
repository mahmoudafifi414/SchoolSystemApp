                        ...
                        <ul className="list-group" id="contact-list">
                            <li className="list-group-item">
                                ...
                                <div className="col-xs-12 col-sm-9">
                                    ...
                                    <span className="glyphicon glyphicon-map-marker text-muted c-info" data-toggle="tooltip"
                                          title="5842 Hillcrest Rd"></span>
                                    <span className="visible-xs"> <span
                                        className="text-muted">5842 Hillcrest Rd</span><br/></span>
                                    <span className="glyphicon glyphicon-earphone text-muted c-info" data-toggle="tooltip"
